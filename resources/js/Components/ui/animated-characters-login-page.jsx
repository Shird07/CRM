  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2 bg-black">
      ...
      <div className="relative hidden lg:flex flex-col justify-between bg-[#E5E5E5] p-12 text-[#2D2D2D]">
        ...
        <div className="relative z-20 flex items-center gap-8 text-sm text-[#555555]">
      ...
      <div className="flex items-center justify-center p-8 bg-black text-white">
        <div className="w-full max-w-[420px]">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                ...
                <Label
                  htmlFor="remember"
                  className="text-sm font-normal text-zinc-400 cursor-pointer select-none"
                >
          ...
          <div className="mt-6">
            <Button 
              variant="outline" 
              className="w-full h-12 bg-black border-zinc-800 hover:bg-zinc-950 text-white hover:text-white transition-colors"
              type="button"
            >
